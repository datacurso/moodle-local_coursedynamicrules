...
/**
 * Testable passgrade_form subclass exposing the protected MoodleQuickForm instance by inheritance.
 *
 * moodleform holds its MoodleQuickForm as the protected $_form property; a subclass can hand it to a
 * test through a public accessor, so the tests never need reflection to reach the activity picker.
 *
 * @package    local_coursedynamicrules
 * @copyright  2026 Industria Elearning <info@industriaelearning.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class testable_passgrade_form extends passgrade_form {
    /**
