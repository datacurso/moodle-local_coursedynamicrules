...
final class per_recipient_notification_name_test extends \advanced_testcase {
    ...
    public function test_each_matched_user_receives_own_name(): void {
        ...
        $this->getDataGenerator()->enrol_user(->id, $course->id, $studentroleid);
        ...
        $this->assertArrayHasKey(->id, $byrecipient);
        ...
        $this->assertStringContainsString('Hola Alicia', $byrecipient[->id]->fullmessagehtml);
        $this->assertStringNotContainsString('Usuario', $byrecipient[->id]->fullmessagehtml);
