...
/**
 * Tests for the condition_form base preload hook.
 *
 * @package    local_coursedynamicrules
 * @coversDefaultClass \local_coursedynamicrules\form\conditions\condition_form
 * @copyright  2026 Industria Elearning <info@industriaelearning.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class condition_form_test extends \advanced_testcase {
    /**
    ...
    public function test_definition_preloads_stored_record_into_form_defaults(): void {
        ...
        $form = new stub_preload_condition_form(
    ...
    public function test_definition_does_not_error_with_null_customdata(): void {
        ...
        $this->assertInstanceOf(condition_form::class, $form);
    }
