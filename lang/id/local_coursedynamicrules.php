...
$string['complete_activity_description'] = 'Pengguna yang telah menyelesaikan modul aktivitas "{$a->moddescription}"';
$string['completiondate'] = 'Tanggal penyelesaian';
$string['componenttargetmissing'] = 'Aktivitas yang dipilih tidak lagi tersedia di kursus ini, sehingga komponen ini tidak akan pernah berlaku.';
...
$string['enableactivity_alreadygated'] = 'Aksi lain sudah membuka "{$a}", dalam aturan ini atau aturan lain. Dua aksi tidak dapat membuka aktivitas yang sama: Moodle mensyaratkan keduanya telah membukanya untuk seorang siswa, sehingga menambahkannya di sini akan menutupnya bagi siswa yang sudah dibukakan oleh aksi lain. Pilih aktivitas lain. Melepaskannya dari aksi lain hanya mungkin selama aturan aksi itu belum pernah diaktifkan.';
$string['enableactivity_description'] = 'Aktifkan aktivitas "{$a}"';
$string['enableactivity_noactivities'] = 'Aktifkan aktivitas: belum ada yang dipilih';
...
$string['errornocoursemodule'] = 'Anda harus memilih aktivitas dari kursus ini.';
...
$string['no_complete_activity_description'] = 'Pengguna yang belum menyelesaikan modul aktivitas "{$a->moddescription}" setelah {$a->expectedcompletiondate}';
...
$string['passgrade_description'] = 'Pengguna yang telah menyelesaikan modul aktivitas "{$a}" dengan nilai lulus';
...
$string['selectanactivity'] = 'Pilih aktivitas';
