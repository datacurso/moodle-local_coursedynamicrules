...
$string['privacy:metadata:datacurso_ai:lang'] = 'El idioma en el que se genera la actividad, tomado de la preferencia de idioma del usuario y, en su defecto, del idioma del curso.';
