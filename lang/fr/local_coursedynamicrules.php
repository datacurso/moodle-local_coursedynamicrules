...
$string['complete_activity_description'] = 'Utilisateurs ayant terminé le module d’activité « {$a->moddescription} »';
$string['completiondate'] = 'Date d’achèvement';
$string['componenttargetmissing'] = 'L’activité sélectionnée n’est plus disponible dans ce cours, ce composant ne pourra donc jamais prendre effet.';
...
$string['enableactivity_alreadygated'] = 'Une autre action ouvre déjà « {$a} », dans cette règle ou une autre. Deux actions ne peuvent pas ouvrir la même activité : Moodle exige que les deux l’aient ouverte pour un étudiant, donc l’ajouter ici la fermerait pour les étudiants auxquels l’autre action l’a ouverte. Choisissez une autre activité. La retirer de l’autre action n’est possible que si la règle de celle-ci n’a jamais été activée.';
$string['enableactivity_description'] = 'Activer les activités « {$a} »';
$string['enableactivity_noactivities'] = 'Activer des activités : aucune choisie pour le moment';
...
$string['errornocoursemodule'] = 'Vous devez sélectionner une activité de ce cours.';
...
$string['no_complete_activity_description'] = 'Utilisateurs qui n’ont pas terminé le module d’activité « {$a->moddescription} » après {$a->expectedcompletiondate}';
...
$string['passgrade_description'] = 'Utilisateurs ayant terminé le module d’activité « {$a} » avec une note de passage';
...
$string['selectanactivity'] = 'Sélectionner une activité';
